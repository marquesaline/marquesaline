...
Se quiser conhecer melhor essa e as outras pastas do Rails, escrevi um post sobre [os arquivos principais e a pasta app/](/rails-arquivos-e-app).
...
Se quiser se aprofundar nas operações de CRUD com ActiveRecord, tenho um post específico sobre [models e CRUD no Rails](/models-crud-rails).
...
Se quiser se aprofundar no papel do controller, escrevi um post específico sobre [controllers no Rails](/controllers-rails).
...
Se quiser ir mais fundo nessa ideia de separar o sistema em camadas com responsabilidades bem definidas, escrevi um post sobre [arquitetura em camadas](/arquitetura-em-camadas) que aborda melhor esse raciocínio.
